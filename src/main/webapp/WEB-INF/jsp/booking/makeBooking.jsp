		...
		<nav>
			<ul class="nav nav-fill">
				...
				<li class="nav-item"><a class="nav-link"
					href="/booking/make-booking-view">예약안내</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/booking/booking-list-view">예약목록</a></li>
			</ul>
		</nav>
		<section class="contents py-4">
			...
			<div class="d-flex justify-content-center">
				<div class="booking-box">
					...
					<input type="text" class="form-control" id="date"> <!-- type="date"로 하면 datepicker를 사용한 효과 -->

					<div class="subject-text my-2 font-weight-bold">숙박일수</div>
					<input type="text" class="form-control" id="day"> <!-- type="number"로 하면 datepicker를 사용한 효과 -->
